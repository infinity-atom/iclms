    ...
    <v-app>
        ...
        <v-main>
            <div class="header-wrapper">
                <iclms-top-nav></iclms-top-nav>
            </div>
            <div class="header-wrapper" v-if="!loaded">
                <v-skeleton-loader type="paragraph" v-for="i in loaders" class="mb-2"></v-skeleton-loader>
            </div>
    ...
    const submitAssignment = async () => {
        try {
            ...
            if(submission_type == "online_upload") {
                ...
                file_upload_input.value.forEach(async (/** @type {File} */ file) => {
                    // upload file
